...
def compute_facial_landmarks(image_fn):
    img = dlib.load_rgb_image(image_fn)
    detection = detector(img, 1)[0]
    facial_landmarks = [(item.x, item.y) for item in shape_predictor(img, detection).parts()]
...
def main():
    src_file = '/home/mookyung/Downloads/labeledAll/00011.png'
    dst_file = '00011_aligned.png'
